  ...
  <div>
    <a-row>
      <a-col :span="12">
        ...
        <br/>
        <div>
          <a-form :inline="true" :model="hkvInfo" class="demo-form-inline">
            <a-row>
              <a-col>
                <a-form-item label="ip">
                  <a-input v-model="hkvInfo.ip" placeholder="ip"></a-input>
                </a-form-item>
                <a-form-item label="port">
                  <a-input v-model="hkvInfo.port" placeholder="port"></a-input>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col>
                <div>
                  <a-form-item label="username">
                    <a-input v-model="hkvInfo.username" placeholder="username"></a-input>
                  </a-form-item>
                  <a-form-item label="password">
                    <a-input v-model="hkvInfo.password" placeholder="password"></a-input>
                  </a-form-item>
                </div>
              </a-col>
            </a-row>
            <a-row>
              <a-col>
                <a-form-item>
                  <a-button type="primary" :loading="loginLoading" @click="onLogin">登录</a-button>
                  <a-button type="primary" :loading="startPlayLoading" @click="clickStartRealPlay">开始预览</a-button>
                  <a-button type="primary" @click="clickStopRealPlay">停止预览</a-button>
        ...
        <div>
          <label>数字通道列表: </label>
          <a-tag type="success" class="my-tag" v-for="(item,index) in hkvInfo.channels" :key="index">{{item}}</a-tag>
        </div>
      </a-col>
      <a-col :span="12">
        <div class="a-button-group ">
          <div class="a-button primary" @mousedown="mouseDownPTZControl(5)" @mouseup="mouseUpPTZControl">左上</div>
          <div class="a-button primary" @mousedown="mouseDownPTZControl(1)" @mouseup="mouseUpPTZControl">向上</div>
          <div class="a-button primary" @mousedown="mouseDownPTZControl(7)" @mouseup="mouseUpPTZControl">右上</div>
        </div>
        <br/>
        <div class="a-button-group ">
          <div class="a-button primary" @mousedown="mouseDownPTZControl(3)" @mouseup="mouseUpPTZControl">向左</div>
          <div class="a-button primary" @mousedown="mouseDownPTZControl(9)" @mouseup="mouseUpPTZControl">自动</div>
          <div class="a-button primary" @mousedown="mouseDownPTZControl(4)" @mouseup="mouseUpPTZControl">向右</div>
        </div>
        <br/>
        <div class="a-button-group ">
          <div class="a-button primary" @mousedown="mouseDownPTZControl(6)" @mouseup="mouseUpPTZControl">左下</div>
          <div class="a-button primary" @mousedown="mouseDownPTZControl(2)" @mouseup="mouseUpPTZControl">向下</div>
          <div class="a-button primary" @mousedown="mouseDownPTZControl(8)" @mouseup="mouseUpPTZControl">右下</div>
        </div>
      </a-col>
    </a-row>
