...
using System.Linq;
using Sharding = EFCore.Sharding;
...
namespace Coldairarrow.DataRepository
{
    ...
    public class ShardingConfig
    {
        ...
        private Util.SynchronizedCollection<DataSource> _dataSource { get; } = new Util.SynchronizedCollection<DataSource>();
        private Util.SynchronizedCollection<AbstractDatabse> _absDb { get; } = new Util.SynchronizedCollection<AbstractDatabse>();
